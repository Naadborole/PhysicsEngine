...
struct ClientGameObjectManagerAddon : public GameObjectManagerAddon
{
	...
	PE_DECLARE_IMPLEMENT_EVENT_HANDLER_WRAPPER(do_CREATE_PoolBall);
	virtual void do_CREATE_PoolBall(PE::Events::Event* pEvt);
	...
	void createPoolBall(Events::Event_CreatePoolBall* pTrueEvent);
	void createPoolBall(Vector3 pos, int& threadOwnershipMask);
